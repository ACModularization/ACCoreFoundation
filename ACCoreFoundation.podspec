...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is ACCoreFoundation
                   DESC

  s.homepage     = "https://github.com/ACModularization/ACCoreFoundation"
  ...
  s.source       = { :git => "https://github.com/ACModularization/ACCoreFoundation.git", :tag => s.version.to_s }
